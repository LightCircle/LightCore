    ...
    function defaults(data) {
      ...
      if (self.strict) {
        return {
          ...
          createBy: self.uid || constant.DEFAULT_USER,
          updateBy: self.uid || constant.DEFAULT_USER
        };
      }
      ...
      return {
        ...
        createBy: data.createBy || self.uid || constant.DEFAULT_USER,
        updateBy: data.updateBy || self.uid || constant.DEFAULT_USER
      };
    }
