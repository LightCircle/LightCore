 ...
 * @module light.framework.http.loader
...
function setupExpress(app, db) {
  ...
  log.debug("express port : " + config.app.port);
  log.debug("express tmp : " + config.app.tmp);
  log.debug("express sessionTimeout : " + config.app.sessionTimeout);
