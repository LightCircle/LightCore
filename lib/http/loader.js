...
exports.loadConfig = function () {
  ...
  process.env.MASTER       = setting.app.master;
  process.env.DEV          = setting.app.dev;
...
exports.parseArgv = function () {
  ...
  // 上传代码
  if (isPush) {
    tool.push.start(function (err, result) {
      if (err) {
        log.error(err);
      }
      log.debug(result);
