 ...
 * @module light.lib.model.importer
 * @version 1.0.0
 */
...
var ETL = module.exports = function ETL(from, to, options) {
  ...
  this.primitive = new Model(this.from, undefined, table, {user: options.primitive.user, pass: options.primitive.pass});

  // 存放加工好的数据collection
  table = options.processed.name || PREFIX + helper.randomGUID4();
  this.processed = new Model(this.to, undefined, table, {user: options.processed.user, pass: options.processed.pass});
};
