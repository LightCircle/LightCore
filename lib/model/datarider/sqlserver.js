...
exports.list = (handler, callback) => {
  handler.params.script = buildScript(handler, handler.api, handler.params);
...
exports.count = (handler, callback) => {
  ...
  let script = buildScript(handler, board, handler.params, {});
...
function buildScript(handler, board, params) {
